...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: "Beachfront Holiday Villas in Fuerteventura | Canary Villas Corralejo",
    description: "Book luxury beachfront holiday villas in Corralejo, Fuerteventura directly. Private sea views, terraces, flexible booking & zero booking fees. From €95/night.",
  ...
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center text-white">
        <Image src="https://pnkxfbsjd3gpupqs.public.blob.vercel-storage.com/header-1.jpg" alt="Beachfront villa in Fuerteventura" fill className="object-cover" priority sizes="100vw" />
