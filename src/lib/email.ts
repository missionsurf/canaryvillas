  ...
  const html = `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
      <div style="position:relative;overflow:hidden;border-radius:12px 12px 0 0;">
        <img src="https://pnkxfbsjd3gpupqs.public.blob.vercel-storage.com/header-1.jpg" alt="Fuerteventura beach" style="width:100%;height:240px;object-fit:cover;display:block;" />
